...
func generateUsers(num int) []*model.UserModel {

	users := make([]*model.UserModel, num)
	for i := 0; i < num; i++ {
...
func generatePosts(num int, users []*model.UserModel) []*model.PostModel {
...
func generateComments(num int, users []*model.UserModel, posts []*model.PostModel) []*model.CommentModel {
